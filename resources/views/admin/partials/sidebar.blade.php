 ...
 <aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ route('audit.create',2) }}">
                <i class="bi bi-layout-text-window-reverse"></i>
                <span>Audit 2</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ route('audit.create',3) }}">
                <i class="bi bi-layout-text-window-reverse"></i>
                <span>Audit 3</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ route('audit.create',4) }}">
                <i class="bi bi-layout-text-window-reverse"></i>
                <span>Audit 4</span>
            </a>
        </li>
