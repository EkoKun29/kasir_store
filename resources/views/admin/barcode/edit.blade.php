    ...
    <div class="card-body">
        ...
        <form action="{{ route('barcode.update', $barcode->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="tanggal_beli" name="tanggal_beli" value="{{ $barcode->tanggal_beli }}">
            </div>

            <div class="form-group">
                <label for="harga_beli">Harga Beli</label>
                <input type="number" class="form-control" id="harga_beli" name="harga_beli" min="1" value="{{ $barcode->harga_beli }}">
            </div>
